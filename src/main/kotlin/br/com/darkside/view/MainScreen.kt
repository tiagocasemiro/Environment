...
import br.com.darkside.defaultHeight
import br.com.darkside.defaultWidth
import br.com.darkside.entity.Variable
import br.com.darkside.view.dialog.AboutAlert
import br.com.darkside.view.dialog.ShortcutsAlert
import br.com.darkside.view.menu.MainMenu
...
class MainScreen : View("Derkside") {
                ...
                MainMenu().attachTo(this) {
                    onOpenPathMenu = {
                        if(controller.path.value != null) {
                            ...
                            warning("", "Não existe path no arquivo de variáveis selecionado.")
                        }
                    }
                    onCreateMenu = {
    ...
    private fun refreshTableView() {
        variables.toMutableList().clear()
        variables.toMutableList().addAll(retrieveVariables().observable())
        tableview.refresh()
    }
